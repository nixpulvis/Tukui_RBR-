...
raidbuff_anchor.text = raidbuff_anchor:CreateFontString(nil, "OVERLAY")	
raidbuff_anchor.text:SetPoint("CENTER", raidbuff_anchor, "CENTER", 0, 0)
raidbuff_anchor.text:SetFont(C.media.font, 12)
...
local function CreateButton(name, relativeTo, firstbutton)
	...
	local function SetupTooltip(self)
		...
		if name == "SpecialBuffFrame" then
			GameTooltip:AddLine(" ")
			GameTooltip:AddLine("Set the SpellID in the core.lua file of this addon", 1,1,1)
		end
		GameTooltip:Show()
	end
